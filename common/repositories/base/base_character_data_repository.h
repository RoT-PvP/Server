...
public:
	struct CharacterData {
		...
		uint32_t	pvp_current_death_streak;
		uint32_t	pvp_infamy;	
		uint32_t	pvp_vitality;
		uint32_t    pvp2;
		uint32_t    pvp_type;
		uint32_t    show_helm;
	...
	)
	{
		...
		if (results.RowCount() == 1) {
			...
			e.pvp_current_death_streak = static_cast<uint32_t>(strtoul(row[81], nullptr, 10));
			e.pvp_infamy	          = static_cast<uint32_t>(strtoul(row[82], nullptr, 10));
			e.pvp_vitality	          = static_cast<uint32_t>(strtoul(row[83], nullptr, 10));
			e.pvp2                    = static_cast<uint32_t>(strtoul(row[84], nullptr, 10));
			e.pvp_type                = static_cast<uint32_t>(strtoul(row[85], nullptr, 10));
			e.show_helm               = static_cast<uint32_t>(strtoul(row[86], nullptr, 10));
			e.group_auto_consent      = static_cast<uint8_t>(strtoul(row[87], nullptr, 10));
			e.raid_auto_consent       = static_cast<uint8_t>(strtoul(row[88], nullptr, 10));
			e.guild_auto_consent      = static_cast<uint8_t>(strtoul(row[89], nullptr, 10));
			e.leadership_exp_on       = static_cast<uint8_t>(strtoul(row[90], nullptr, 10));
			e.RestTimer               = static_cast<uint32_t>(strtoul(row[91], nullptr, 10));
			e.air_remaining           = static_cast<uint32_t>(strtoul(row[92], nullptr, 10));
			e.autosplit_enabled       = static_cast<uint32_t>(strtoul(row[93], nullptr, 10));
			e.lfp                     = static_cast<uint8_t>(strtoul(row[94], nullptr, 10));
			e.lfg                     = static_cast<uint8_t>(strtoul(row[95], nullptr, 10));
			e.mailkey                 = row[96] ? row[96] : "";
			e.xtargets                = static_cast<uint8_t>(strtoul(row[97], nullptr, 10));
			e.firstlogon              = static_cast<int8_t>(atoi(row[98]));
			e.e_aa_effects            = static_cast<uint32_t>(strtoul(row[99], nullptr, 10));
			e.e_percent_to_aa         = static_cast<uint32_t>(strtoul(row[100], nullptr, 10));
			e.e_expended_aa_spent     = static_cast<uint32_t>(strtoul(row[101], nullptr, 10));
			e.aa_points_spent_old     = static_cast<uint32_t>(strtoul(row[102], nullptr, 10));
			e.aa_points_old           = static_cast<uint32_t>(strtoul(row[103], nullptr, 10));
			e.e_last_invsnapshot      = static_cast<uint32_t>(strtoul(row[104], nullptr, 10));
	...
	)
	{
		...
		v.push_back(columns[81] + " = " + std::to_string(e.pvp_current_death_streak));
		v.push_back(columns[82] + " = " + std::to_string(e.pvp_infamy));
		v.push_back(columns[83] + " = " + std::to_string(e.pvp_vitality));
		v.push_back(columns[84] + " = " + std::to_string(e.pvp2));
		v.push_back(columns[85] + " = " + std::to_string(e.pvp_type));
		v.push_back(columns[86] + " = " + std::to_string(e.show_helm));
		v.push_back(columns[87] + " = " + std::to_string(e.group_auto_consent));
		v.push_back(columns[88] + " = " + std::to_string(e.raid_auto_consent));
		v.push_back(columns[89] + " = " + std::to_string(e.guild_auto_consent));
		v.push_back(columns[90] + " = " + std::to_string(e.leadership_exp_on));
		v.push_back(columns[91] + " = " + std::to_string(e.RestTimer));
		v.push_back(columns[92] + " = " + std::to_string(e.air_remaining));
		v.push_back(columns[93] + " = " + std::to_string(e.autosplit_enabled));
		v.push_back(columns[94] + " = " + std::to_string(e.lfp));
		v.push_back(columns[95] + " = " + std::to_string(e.lfg));
		v.push_back(columns[96] + " = '" + Strings::Escape(e.mailkey) + "'");
		v.push_back(columns[97] + " = " + std::to_string(e.xtargets));
		v.push_back(columns[98] + " = " + std::to_string(e.firstlogon));
		v.push_back(columns[99] + " = " + std::to_string(e.e_aa_effects));
		v.push_back(columns[100] + " = " + std::to_string(e.e_percent_to_aa));
		v.push_back(columns[101] + " = " + std::to_string(e.e_expended_aa_spent));
		v.push_back(columns[102] + " = " + std::to_string(e.aa_points_spent_old));
		v.push_back(columns[103] + " = " + std::to_string(e.aa_points_old));
	...
	)
	{
		...
		v.push_back(std::to_string(e.pvp_current_death_streak));
		v.push_back(std::to_string(e.pvp_infamy));
		v.push_back(std::to_string(e.pvp_vitality));
